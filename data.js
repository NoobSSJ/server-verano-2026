...
const SERVER = {
  name:    "MineCraft Pro Server",
  ip:      "play.miservermc.es",
  port:    25565,
  version: "1.21.x · Paper",
  motd:    "¡Supervivencia, comunidad y aventura!",
  maxPlayers: 20,
...
const ONLINE_PLAYERS = [
  { name:"Steve",    avatar:"https://mc-heads.net/avatar/Steve/40",    role:"Admin",   joinedAt: new Date(Date.now()-5400000).toISOString(),  totalMinutes:8420, location:"El Valle de los Cristales", status:"Construyendo" },
  { name:"Alex",     avatar:"https://mc-heads.net/avatar/Alex/40",     role:"Mod",     joinedAt: new Date(Date.now()-1800000).toISOString(),  totalMinutes:6130, location:"Cavernas del Nether",      status:"Minando"      },
  { name:"Enderman", avatar:"https://mc-heads.net/avatar/Enderman/40", role:"VIP",     joinedAt: new Date(Date.now()-900000).toISOString(),   totalMinutes:3250, location:"El Fin",                   status:"Explorando"   },
  { name:"Diamond",  avatar:"https://mc-heads.net/avatar/Diamond/40",  role:"Jugador", joinedAt: new Date(Date.now()-300000).toISOString(),   totalMinutes:1870, location:"Spawn Principal",           status:"AFK"          },
];

/* ── TODOS LOS JUGADORES (para la página /players) ────────────────────────── */
const ALL_PLAYERS = [
  { name:"Steve",    avatar:"https://mc-heads.net/avatar/Steve/40",    role:"Admin",   totalMinutes:8420,  lastSeen:"Conectado",    joined:"01/01/2025", achievements:142, deaths:12  },
  { name:"Alex",     avatar:"https://mc-heads.net/avatar/Alex/40",     role:"Mod",     totalMinutes:6130,  lastSeen:"Conectado",    joined:"15/01/2025", achievements:118, deaths:34  },
  { name:"Herobrine",avatar:"https://mc-heads.net/avatar/Herobrine/40",role:"Builder", totalMinutes:5900,  lastSeen:"hace 2 días",  joined:"01/02/2025", achievements:201, deaths:7   },
  { name:"Notch",    avatar:"https://mc-heads.net/avatar/Notch/40",    role:"Builder", totalMinutes:4710,  lastSeen:"hace 5 horas", joined:"10/02/2025", achievements:95,  deaths:56  },
  { name:"Enderman", avatar:"https://mc-heads.net/avatar/Enderman/40", role:"VIP",     totalMinutes:3250,  lastSeen:"Conectado",    joined:"01/03/2025", achievements:77,  deaths:23  },
  { name:"Creeper",  avatar:"https://mc-heads.net/avatar/Creeper/40",  role:"Jugador", totalMinutes:2100,  lastSeen:"hace 1 semana",joined:"05/03/2025", achievements:43,  deaths:89  },
  { name:"Diamond",  avatar:"https://mc-heads.net/avatar/Diamond/40",  role:"Jugador", totalMinutes:1870,  lastSeen:"Conectado",    joined:"01/04/2025", achievements:61,  deaths:44  },
  { name:"Zombie",   avatar:"https://mc-heads.net/avatar/Zombie/40",   role:"Jugador", totalMinutes:980,   lastSeen:"hace 3 días",  joined:"20/04/2025", achievements:28,  deaths:112 },
];
